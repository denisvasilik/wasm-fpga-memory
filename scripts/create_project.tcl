...
set project_name "WasmFpgaMemory"
...
set files_vhd [list \
 [file normalize "${project_src}/WasmFpgaMemory.vhd" ]\
 [file normalize "${project_src}/WasmFpgaMemoryPackage.vhd" ]\
...
set obj [get_filesets sources_1]
set_property -name "top" -value "WasmFpgaMemory" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
set_property -name "top_file" -value "${project_src}/WasmFpgaMemory.vhd" -objects $obj
...
set files [list \
 "[file normalize "${project_tb}/tb_WasmFpgaMemory.vhd"]"\
...
set files [list \
 "[file normalize "${project_ip}/WasmFpgaMemoryRam/WasmFpgaMemoryRam.xci"]"\
]
...
set obj [get_filesets sim_1]
set_property "top" "tb_WasmFpgaMemory" $obj
