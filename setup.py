...
setuptools.setup(
    ...
    package_data={},
    data_files=[
        ("wasm-fpga-memory/package", ["package/component.xml"]),
        ("wasm-fpga-memory/package/bd", ["package/bd/bd.tcl"]),
        ("wasm-fpga-memory/package/xgui", ["package/xgui/wasm_fpga_memory_v1_0.tcl"]),
        (
        ...
        ("wasm-fpga-memory", ["CHANGELOG.md", "AUTHORS", "LICENSE"]),
    ],
    setup_requires=[],
    install_requires=[],
    entry_points={},
